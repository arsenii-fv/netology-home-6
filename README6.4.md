...
При проектировании структуры таблицы возможно разбить таблицу на части по определенным условиям.
Но в таком случае необходимо представлять что будет храниться в БД.
````
### Задача 4
````
